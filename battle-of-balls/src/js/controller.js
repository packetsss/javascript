...
export default class Joystick extends PIXI.Container {
    ...
    initialize() {
        ...
        this.outerRadius = this.width / 1.7;
    ...
    bindEvents() {
        ...
        function onDragStart(event) {
            ...
            that.position.set(event.data.global.x, event.data.global.y);

            startPosition = { x: 0, y: 0 };
            // startPosition = eventData.getLocalPosition(that);

            dragging = true;
            that.inner.alpha = 0.8;
